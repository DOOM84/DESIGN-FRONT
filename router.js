...
const routes = [
  ...
  {path: '/upload', name: 'designs.upl', component: page('user/designs/create.vue')},
  {path: '/designs/:id/edit', name: 'designs.edit', component: page('user/designs/edit.vue')},
  {
    path: '/settings', component: page('user/settings/index.vue'),
    children: [
      {path: '', redirect: {name: 'settings.dashboard'},},
      {path: 'dashboard',  name: 'settings.dashboard', component: page('user/settings/dashboard.vue')},
      {path: 'profile',  name: 'settings.profile', component: page('user/settings/profile.vue')},
      {path: 'designs',  name: 'settings.designs', component: page('user/settings/designs.vue')},

    ]
  },
  {path: '/designs', name: 'designs.search', component: page('designs/search.vue')},
  {path: '/design/:slug', name: 'designs.show', component: page('designs/show.vue')},
